...
vim.keymap.set('n', '<leader>db', ':DBUI<CR>', { silent = true, desc = '[DB] UI' })
...
-- vim.keymap.set('n', '<leader>hr', '<cmd>HurlRun<CR>', { desc = "Run hurl file in buffer and paste it's content in:o a split window" })
